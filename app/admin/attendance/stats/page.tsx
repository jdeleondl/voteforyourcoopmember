  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Estadísticas en Vivo</h1>
          <p className="text-gray-600">Dashboard de asistencia en tiempo real - COOPINTEC 2025</p>
        </div>
      ...
      <div className="bg-white rounded-xl shadow-lg p-6 mb-6">
        ...
        <div className="w-full bg-gray-200 rounded-full h-8 overflow-hidden">
          ...
          >
            {(stats?.attendancePercentage || 0) > 5 && `${stats?.attendancePercentage.toFixed(1)}%`}
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-lg overflow-hidden">
        ...
        {stats?.attendees && stats.attendees.length > 0 ? (
            ...
            <table className="w-full">
              <thead className="bg-gray-50">
                <tr>
                  ...
                  <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Hora de Confirmación</th>
                </tr>
              </thead>
              <tbody className="bg-white divide-y divide-gray-200">
                {stats.attendees.map((attendee, index) => (
                  <tr key={index} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600">{attendee.employeeId}</td>
          ...
          <div className="text-center py-12 px-4">
            ...
            <p className="text-gray-500 text-lg">No hay asistentes confirmados</p>
          </div>
        )}
      </div>
    </div>
